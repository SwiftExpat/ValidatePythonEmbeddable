...
uses
  ...
  FMX.TMSFNCGraphicsTypes, FMX.TMSFNCCustomControl, FMX.TMSFNCStatusBar, FMX.TMSFNCToolBar, FMX.TMSFNCPageControl,
  FMX.TMSFNCTabSet, PythonEngine, FMX.TMSFNCTreeViewBase, FMX.TMSFNCTreeViewData, FMX.TMSFNCCustomTreeView,
  FMX.TMSFNCTreeView, FMX.TMSFNCObjectInspector, FMX.TMSFNCCustomComponent, FMX.TMSFNCTaskDialog, FMX.Memo.Types,
  FMX.Controls.Presentation, FMX.ScrollBox, FMX.Memo, FMX.TMSFNCSplitter, FMX.PythonGUIInputOutput;
...
type
  TfrmValidateP4D = class(TForm)
    ...
    memoIDECmd: TMemo;
    TMSFNCSplitter2: TTMSFNCSplitter;
...
uses System.IOUtils, FMX.SEFNC.Logger, FMX.SEFNC.CVLoggerViewer;
